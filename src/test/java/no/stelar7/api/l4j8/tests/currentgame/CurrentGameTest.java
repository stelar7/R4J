...
public class CurrentGameTest
{
    ...
    final DataCallBuilder featuredbuilder = DataCall.builder();
    final DataCallBuilder currentbuilder  = DataCall.builder();
    final DataCallBuilder idbuilder       = DataCall.builder();
