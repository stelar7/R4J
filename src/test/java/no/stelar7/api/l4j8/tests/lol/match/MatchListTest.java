package no.stelar7.api.l4j8.tests.lol.match;
...
import no.stelar7.api.l4j8.impl.lol.builders.match.*;
...
public class MatchListTest
{
    ...
    public void testMatchlistError()
    {
        ...
        List<MatchReference> refs = l4j8.getLoLAPI().getMatchAPI().getMatchList(region, accountId, null, null, null, null, queueTypes, null, null);
