...
public class SeasonTypeDeserializer implements JsonDeserializer<SeasonType>
{
    ...
    @Override
    public SeasonType deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
    {
        String id = json.getAsString();
        return SeasonType.getFromCode(id).orElseThrow(() -> new APIEnumNotUpToDateException(typeOfT, json));
    }
}