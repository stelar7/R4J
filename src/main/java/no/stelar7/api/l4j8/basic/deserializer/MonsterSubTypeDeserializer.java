...
public class MonsterSubTypeDeserializer implements JsonDeserializer<MonsterSubType>
{
    ...
    @Override
    public MonsterSubType deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
    {
        String id = json.getAsString();
        return MonsterSubType.getFromCode(id).orElseThrow(() -> new APIEnumNotUpToDateException(typeOfT, json));
    }
}
