...
public class TournamentMapTypeDeserializer implements JsonDeserializer<TournamentMapType>
{
    ...
    public TournamentMapType deserialize(JsonElement json, Type t, JsonDeserializationContext context)
    {
        ...
        return retu.map(o -> (TournamentMapType) o).orElseGet(() -> (TournamentMapType) CodedEnum.printError(t, id));
    }
}
