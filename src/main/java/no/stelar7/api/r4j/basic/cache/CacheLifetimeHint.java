...
public class CacheLifetimeHint
{
    ...
    static
    {
        ...
        DEFAULTS.add(URLEndpoint.V5_MATCHLIST_REPLAYS, MINUTES_10);
        ...
        DEFAULTS.add(URLEndpoint.V1_VAL_LEADERBOARD_BY_ACT, MINUTES_30);
        ...
        DEFAULTS.add(URLEndpoint.V1_CHALLENGES_BY_PLAYER, DAYS_1);
        DEFAULTS.add(URLEndpoint.V1_CHALLENGES_PERCENTILES, DAYS_1);
        DEFAULTS.add(URLEndpoint.V1_CHALLENGES_PERCENTILES_BY_ID, DAYS_1);
        DEFAULTS.add(URLEndpoint.V1_CHALLENGES_CONFIG, DAYS_1);
        DEFAULTS.add(URLEndpoint.V1_CHALLENGES_CONFIG_BY_ID, DAYS_1);
        DEFAULTS.add(URLEndpoint.V1_CHALLENGES_LEADERBOARD_BY_LEVEL, DAYS_1);
    }
}
